...
export const gymController = {
  ...
  async listMembers(req: Request, res: Response) {
    return ok(res, await gymCore.listMembers(req.query, (req as any).authContext), "Members fetched successfully");
  },
  async createMember(req: Request, res: Response) {
    return created(res, await gymCore.createMember(req.body, (req as any).authContext), "Member created successfully");
  },
  async getMemberById(req: Request, res: Response) {
    return ok(res, await gymCore.getMemberById(req.params.id, (req as any).authContext), "Member fetched successfully");
  },
  ...
  async deleteMember(req: Request, res: Response) {
    return ok(res, await gymCore.deleteMember(req.params.id, (req as any).authContext), "Member removed successfully");
  },
  async listPayments(req: Request, res: Response) {
    return ok(res, await gymCore.listPayments(req.query, (req as any).authContext), "Payments fetched successfully");
  },
  async createPayment(req: Request, res: Response) {
    return created(res, await gymCore.createPayment(req.body, (req as any).authContext), "Payment recorded successfully");
  },
